...
from shared.models.common.normalizer import LinearNormalizer, SingleFieldLinearNormalizer
...
def test():
    ...
    print(f"Normalized action mean: {np.mean(normalized_actions, axis=0)}, "
