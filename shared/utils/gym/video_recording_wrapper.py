...
https://github.com/real-stanford/diffusion_policy/blob/main/diffusion_policy/gym_util/video_recording_wrapper.py
...
from shared.utils.real_world.video_recorder import VideoRecorder
